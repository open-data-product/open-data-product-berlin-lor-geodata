...
class DistrictsTestCase(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        # Load geojson file
        with open(file=os.path.join(data_path, "berlin-lor-districts", "bezirksgrenzen.geojson"), mode="r",
...
class ForecastAreasTestCase(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        # Load geojson file
        with open(file=os.path.join(data_path, "berlin-lor-forecast-areas-until-2020", "lor_prognoseraeume.geojson"),
                  mode="r", encoding="utf-8") as geojson_file:
            self.geojson_until_2020 = json.load(geojson_file, strict=False)
        with open(
                file=os.path.join(data_path, "berlin-lor-forecast-areas-from-2021", "lor_prognoseraeume_2021.geojson"),
                mode="r", encoding="utf-8") as geojson_file:
...
class DistrictRegionsTestCase(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        # Load geojson file
        with open(file=os.path.join(data_path, "berlin-lor-district-regions-until-2020", "lor_bezirksregionen.geojson"),
                  mode="r", encoding="utf-8") as geojson_file:
            self.geojson_until_2020 = json.load(geojson_file, strict=False)
        with open(file=os.path.join(data_path, "berlin-lor-district-regions-from-2021",
...
class PlanningAreasTestCase(unittest.TestCase):
    def __init__(self, *args, **kwargs):
        ...
        # Load geojson file
        with open(file=os.path.join(data_path, "berlin-lor-planning-areas-until-2020", "lor_planungsraeume.geojson"),
                  mode="r", encoding="utf-8") as geojson_file:
            self.geojson_until_2020 = json.load(geojson_file, strict=False)
        with open(
                file=os.path.join(data_path, "berlin-lor-planning-areas-from-2021", "lor_planungsraeume_2021.geojson"),
                mode="r", encoding="utf-8") as geojson_file:
            self.geojson_from_2021 = json.load(geojson_file, strict=False)
